...
public class Way2SMS {
    ...
    {  
        final String USERNAME="8124535118";//REQUIRED
        final String PASSWORD="12345";//REQUIRED
        final String ACTION="C7DBCA4628B0776A038AF4CE7DC777EB.w806";//REQUIRED : In order to understand ACTION value please read the blog
        ...
        String textMessage="hi da";
        String strPhoneNumber="9047286162";
