...
public class OrderEntity {
	...
	private Integer bfAddress;
	@Column(name = "lunch_address")
	private Integer lunchAddress;
	@Column(name = "dinner_address")
	private Integer dinnerAddress;

	public int getBfAddress() {
		return bfAddress;
	}

	public void setBfAddress(int bfAddress) {
	...
	public String toString() {
		return "OrderEntity [clientId=" + clientId + ", orderId=" + orderId + ", planKey=" + planKey
				+ ", foodOrderFromDate=" + foodOrderFromDate + ", foodOrderToDate=" + foodOrderToDate
				+ ", totalBillAmt=" + totalBillAmt + ", orderStatus=" + orderStatus + ", orphanageFlag=" + orphanageFlag
				+ ", breakfastTime=" + breakfastTime + ", lunchTime=" + lunchTime + ", dinnerTime=" + dinnerTime
				+ ", insertDate=" + insertDate + ", updateDate=" + updateDate + ", menu=" + menu
				+ ", orderCancellationFlag=" + orderCancellationFlag + ", bfAddress=" + bfAddress + ", lunchAddress="
				+ lunchAddress + ", dinnerAddress=" + dinnerAddress + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + lunchAddress;
	...
	public boolean equals(Object obj) {
		...
		if (clientId != other.clientId)
			return false;
		if (dinnerAddress != other.dinnerAddress)
			return false;
		if (dinnerTime == null) {
		...
		if (insertDate == null) {
			...
			return false;
		if (lunchAddress != other.lunchAddress)
			return false;
		if (lunchTime == null) {
